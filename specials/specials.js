...
var array = ["empty_string"];
      ...
      for(var aa = 0; aa < array_keys.length; aa++){
        ...
        if (!(array.contains(loc))) {
            ...
            listItem.innerHTML = '<a class="btn btn-primary btn-sm btn-block text-center" data-toggle="collapse" href="#loc' + locStr + '"role="button" aria-expanded="false" aria-controls="loc' + locStr + '">' + loc + '</a>';
